...
const secondaryFont = Nunito({ subsets: ['latin'], weight: ["300" , "400" , "500" , "700" , "900"], display: "swap", variable: "--secondary-font" })

export const metadata: Metadata = {
  title: 'The Plug Services - Business Outsourcing',
  description: 'The Plug Services - Business Outsourcing'
}
